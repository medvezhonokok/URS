...
const router = createBrowserRouter([
    ...
    },
    {
        ...
        name: 'CompanyPage',
        element: <div><CompanyPage user={getUser()}/></div>,
    },
    {
        path: '/user/:userId',
        name: 'UserPage',
        element: <div><UserPage authUser={getUser()}/></div>,
    },
    {
        path: '/common',
        name: 'CommonSchedulePage',
        element: <div><CommonSchedulePage user={getUser()}/></div>,
    },
]);
